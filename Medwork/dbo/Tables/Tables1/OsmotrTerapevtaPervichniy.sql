CREATE TABLE [dbo].[OsmotrTerapevtaPervichniy] (
    [ID]                                                            INT           NOT NULL,
    [PatID]                                                         INT           NULL,
    [Data]                                                          DATETIME      NULL,
    [Vrach]                                                         INT           NULL,
    ...
    CONSTRAINT [OsmotrTerapevtaPervichniyPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [OsmotrTerapevtaPervichniyToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
