CREATE TABLE [dbo].[OsmotrOkulistaPervichniy] (
    [ID]                      INT            NOT NULL,
    [PatID]                   INT            NULL,
    ...
    [Data]                    DATETIME       NULL,
    [Vrach]                   INT            NULL,
    CONSTRAINT [OsmotrOkulistaPervichniyPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [OsmotrOkulistaPervichniyToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
