CREATE TABLE [dbo].[PervichniyOsmotrImmunologa] (
    [ID]                                                            INT           NOT NULL,
    [PatID]                                                         INT           NULL,
    [Data]                                                          DATETIME      NULL,
    ...
    [DiastolicheskiyNaVerhushkeVTochkeBotkinaIIIIIVToni]            NVARCHAR (1)  NULL,
    CONSTRAINT [PervichniyOsmotrImmunologaPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [PervichniyOsmotrImmunologaToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
