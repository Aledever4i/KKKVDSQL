CREATE TABLE [dbo].[PovtorniyPriMOkulista] (
    [ID]                      INT            NOT NULL,
    [PatID]                   INT            NULL,
    [Data]                    DATETIME       NULL,
    [Vrach]                   INT            NULL,
    ...
    CONSTRAINT [PovtorniyPriMOkulistaPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [PovtorniyPriMOkulistaToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
