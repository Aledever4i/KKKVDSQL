CREATE TABLE [dbo].[PriemOkulista] (
    [ID]                                            INT            NOT NULL,
    [PatID]                                         INT            NULL,
    [Zhalobi]                                       NTEXT          NULL,
    ...
    CONSTRAINT [PriemOkulistaPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [PriemOkulistaToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
