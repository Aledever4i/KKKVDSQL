CREATE TABLE [dbo].[PriemVracha_Oftalmolog_RezultatiBiometrii] (
    [ID]           INT           NOT NULL,
    [PatID]        INT           NULL,
    ...
    CONSTRAINT [PriemVracha_Oftalmolog_RezultatiBiometriiPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [PriemVracha_Oftalmolog_RezultatiBiometriiToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
