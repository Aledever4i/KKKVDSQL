CREATE TABLE [dbo].[PovtorniyPriMGinekologa] (
    [ID]                                        INT           NOT NULL,
    [PatID]                                     INT           NULL,
    ...
    [Data]                                      DATETIME      NULL,
    [Vrach]                                     INT           NULL,
    CONSTRAINT [PovtorniyPriMGinekologaPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [PovtorniyPriMGinekologaToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
