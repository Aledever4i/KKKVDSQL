CREATE TABLE [dbo].[PervichniyPriemInfektsionista] (
    [ID]                                            INT           NOT NULL,
    [PatID]                                         INT           NULL,
    [Zhalobi]                                       NTEXT         NULL,
    ...
    [Data]                                          DATETIME      NULL,
    [Vrach]                                         INT           NULL,
    CONSTRAINT [PervichniyPriemInfektsionistaPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [PervichniyPriemInfektsionistaToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
