CREATE TABLE [dbo].[OsmotrOnkologaPervichniy] (
    [ID]                                                            INT           NOT NULL,
    [PatID]                                                         INT           NULL,
    [Data]                                                          DATETIME      NULL,
    ...
    CONSTRAINT [OsmotrOnkologaPervichniyPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [OsmotrOnkologaPervichniyToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
