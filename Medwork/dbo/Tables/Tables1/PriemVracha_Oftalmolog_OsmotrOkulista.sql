CREATE TABLE [dbo].[PriemVracha_Oftalmolog_OsmotrOkulista] (
    [ID]                                            INT            NOT NULL,
    [PatID]                                         INT            NULL,
    [Zhalobi]                                       NTEXT          NULL,
    ...
    [PredvaritelniyDiagnoz]                         NVARCHAR (80)  NULL,
    CONSTRAINT [PriemVracha_Oftalmolog_OsmotrOkulistaPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [PriemVracha_Oftalmolog_OsmotrOkulistaToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
