CREATE TABLE [dbo].[OsmotrKardiologaPervichniy] (
    [ID]                        INT           NOT NULL,
    [PatID]                     INT           NULL,
    [Data]                      DATETIME      NULL,
    [Vrach]                     INT           NULL,
    ...
    [EditBox3]                  INT           NULL,
    [EditBox4]                  INT           NULL,
    CONSTRAINT [OsmotrKardiologaPervichniyPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [OsmotrKardiologaPervichniyToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
