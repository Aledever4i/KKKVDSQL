CREATE TABLE [dbo].[StatusPraesensCommunis] (
    [ID]                                           INT           NOT NULL,
    [PatID]                                        INT           NULL,
    ...
    [SrednyayaPodmishechnayaLiniya2]               NVARCHAR (50) NULL,
    ...
    [Puls2]                                        INT           NULL,
    [Defitsit2]                                    INT           NULL,
    [GranitsiSerdtsa2]                             INT           NULL,
    [VerhushechniyTolchok2]                        INT           NULL,
    [ShumiSerdtsa2]                                NVARCHAR (50) NULL,
    [HarakteristikaShumov]                         NVARCHAR (60) NULL,
    ...
    [GrigivieVipachvaniya]                         NVARCHAR (50) NULL,
    [PosleoperacionnieRubci]                       NVARCHAR (50) NULL,
    [Zhivot2]                                      NVARCHAR (50) NULL,
    [Zhivot3]                                      NVARCHAR (50) NULL,
    [GrijivieVipachivaniya]                        NVARCHAR (50) NULL,
    ...
    CONSTRAINT [StatusPraesensCommunisPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [StatusPraesensCommunisToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
