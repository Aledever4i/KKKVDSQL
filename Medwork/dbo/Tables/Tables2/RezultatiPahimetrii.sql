CREATE TABLE [dbo].[RezultatiPahimetrii] (
    [ID]       INT           NOT NULL,
    [PatID]    INT           NULL,
    [Data]     DATETIME      NULL,
    ...
    CONSTRAINT [RezultatiPahimetriiPrimKey] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [RezultatiPahimetriiToPatForm] FOREIGN KEY ([ID]) REFERENCES [dbo].[PatForm] ([ID]) ON DELETE CASCADE
);
